ai.bodyart-israel.com – пакет файлов для GitHub Pages
...
- CNAME — файл с текстом `ai.bodyart-israel.com` (для привязки домена в GitHub Pages).

Быстрый деплой на GitHub Pages:
1) Создайте публичный репозиторий, например `ai-bodyart-israel-com`.
2) Загрузите файлы из архива в корень репозитория.
3) Settings → Pages:
   - Source: Deploy from branch
   - Branch: main / root
4) Дождитесь адреса вида `https://USERNAME.github.io/REPO/`.
5) В Custom domain укажите `ai.bodyart-israel.com` и сохраните.
6) В GoDaddy → DNS добавьте CNAME:
   - Host/Имя: ai
   - Points to/Значение: USERNAME.github.io
   - TTL: 1 hour
7) Проверьте `https://ai.bodyart-israel.com/ai.txt`
